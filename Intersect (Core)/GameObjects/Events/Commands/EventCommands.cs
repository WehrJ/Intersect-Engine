...
namespace Intersect.GameObjects.Events.Commands
{
    ...
    public class JoinFactionCommand : EventCommand 
    {
        ...
        public JoinFactionCommand(Dictionary<Guid, List<EventCommand>> commandLists)
        {
            for (var i = 0; i<BranchIds.Length; i++)
            {
                BranchIds[i] = Guid.NewGuid();
        ...
        public override EventCommandType Type { get; } = EventCommandType.JoinFaction;
